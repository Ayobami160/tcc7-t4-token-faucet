...
export default function TokenFaucet() {
    ...
    const copyWallet = async () => {
        await navigator.clipboard.writeText('0x71C...3F9a');
        setCopied(true);
                ...
                <div className="grid w-full max-w-[940px] grid-cols-1 gap-7 lg:grid-cols-[1fr_1fr]">
                    ...
                    <section className="rounded-[18px] border border-white/[0.12] bg-[#0b0b0b]/90 p-5 shadow-[0_20px_80px_rgba(0,0,0,0.45)] backdrop-blur-xl sm:p-7">
                        ...
                        <div className="relative mb-5">
                            ...
                            {/* Dropdown */}
                            {networkOpen && (
                                <div className="absolute left-0 right-0 top-[66px] z-50 overflow-hidden rounded-lg border border-yellow-600/30 bg-[#111111] p-1.5 shadow-[0_15px_40px_rgba(0,0,0,0.6)]">
                                    {networks.map((network) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`flex w-full items-center justify-between rounded-md px-3 py-2.5 text-left text-sm transition ${isSelected
                                                    ? 'bg-yellow-500/10 text-[#ffc21a]'
                        ...
                        <div className="mb-5">
                            ...
                            {copied && (
                                <p className="mt-1.5 text-[10px] text-[#ffc21a]">
                                    Address copied
                                </p>
                            )}
                        </div>
                    ...
                    <section className="flex flex-col gap-3">
                        ...
                        <DashboardCard>
                            <div>
                                ...
                                <p className="mt-1 text-[19px] font-medium tracking-wide text-white/90">
                                    ...
                                    h : {String(timeLeft.minutes).padStart(2, '0')}
                                    m : {String(timeLeft.seconds).padStart(2, '0')}
                                    s
                                </p>
                            </div>
                        ...
                        <div className="rounded-[15px] border border-white/[0.12] bg-[#0b0b0b]/90 px-4 py-4 shadow-[0_20px_80px_rgba(0,0,0,0.35)] backdrop-blur-xl">
                            <div className="mb-4 flex items-center justify-between">
                                <h2 className="text-[11px] font-medium text-white/80">
                                    Recent Claims
                                </h2>

                                <button className="text-[9px] text-[#ffc21a] transition hover:text-yellow-300">
                                    View all
                                </button>
                            </div>
                            ...
                            <div className="space-y-3">
                                {recentClaims.map((claim) => (
                                    <div
                                        key={claim.wallet}
                                        className="grid grid-cols-[1fr_auto_auto] items-center gap-4 text-[10px]"
                                    >
